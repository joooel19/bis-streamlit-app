...
def _query_endpoint(endpoint_name: str, messages: list[dict[str, str]], max_tokens, system_prompt: str = None) -> list[dict[str, str]]:
    """Calls a model serving endpoint, optionally with a system prompt."""
...
def query_endpoint(endpoint_name, messages, max_tokens, system_prompt: str = None):
    """
    ...
    You can optionally pass a system_prompt to set the assistant's behavior.
    """
    return _query_endpoint(endpoint_name, messages, max_tokens, system_prompt=system_prompt)[-1]
